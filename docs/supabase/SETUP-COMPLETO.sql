...
-- =============================================================================
-- §10  RANKING — snapshots públicos (v3, sem Redis/webhook)
-- =============================================================================
...
--   Table Editor: profiles, polls, questions, options, votes, ranking_snapshots
--   Database → Views: poll_results, poll_ranking_feed
